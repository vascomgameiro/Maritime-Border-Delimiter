"""
This module contains the Point class which represents a point on the globe.
"""
...
class Point:
    ...
    def __init__(self, point_id: str, latitude: float, longitude: float) -> None:
        ...
        self.__y = nautical(meters=int(self.get_latitude() * lat_dist))
        self.__x = nautical(meters=int(self.get_longitude() * lat_dist * math.cos(math.radians(self.get_latitude()))))
